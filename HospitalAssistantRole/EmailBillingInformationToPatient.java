...
//        
//    }
    EmailBillingInformationToPatient(JPanel userProcessContainer, Account_Billing_request accountBillingRequest) {
        initComponents();
    ...
    private void btnSendEmailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendEmailActionPerformed
        ...
        if (emailTxtFiled.getText().trim().equals("")) {
         ...
         JOptionPane.showMessageDialog(null, "Billing information sent to " +emailTxtFiled.getText() );
       
        SendMail(emailTxtFiled.getText());
    ...
    private void SendMail(String toMail) {
        String to = toMail;
        String from = "dsnikhi@gmail.com";
        String host = "smtp.gmail.com";
        
        Properties properties = new Properties();

        // Setup mail server
        properties.put("mail.smtp.from", "dsnikhi@gmail.com");
        properties.put("mail.smtp.host", host);
        properties.put("mai.smtp.auth", "true");
        properties.put("mail.smtp.starttls.enable", "true");
        properties.put("mail.smtp.port", "587");
        properties.setProperty("mail.smtp.user", from);
        properties.setProperty("mail.smtp.password", "9066923560");
        properties.setProperty("mail.smtp.auth", "true");

        Session session = Session.getDefaultInstance(properties, new javax.mail.Authenticator() {
           @Override
            protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
                return new javax.mail.PasswordAuthentication("dsnikhi@gmail.com", "9066923560");
            }
        });
        ...
        try {
            ...
            message.setFrom(new InternetAddress("dsnikhi@gmail.com"));
